$(document).ready(function () {
    ...
    function populateAbout() {
        ...
        var aboutContent = $("<p id='about-text'>I have undergraduated with microbilogy and Masters's degree from the University of DeVry - Keller -   Information Systems Management graduated with a specialization in Database administration also anlstic and Management   . After graduating, I taught myself how to program in html ,Javascriptie,css,but it wasn't enough, After a few months I decadid to join to have full understund of front and end devloper at uc davis bootcopm . </p>")
