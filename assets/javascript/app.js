$(document).ready(function () {
    ...
    function populateAbout() {
        ...
        var aboutContent = $("<p id='about-text'>I graduated from the University of DeVry - Keller - with a Masters's degree. After graduating, I taught myself how to program in Javascriptie  and and how to use Android Studio. After a few months, . </p>")
